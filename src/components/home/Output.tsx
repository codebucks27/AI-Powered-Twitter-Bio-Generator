...
const RenderOutput = () => {
  ...
  return (
    <div className="relative flex h-full mt-2 min-h-[50vh] flex-col rounded-xl bg-muted/50 backdrop-blur-sm overflow-hidden border border-primary/10">
      {loading ? <BorderBeam size={1000} borderWidth={1} duration={8} /> : null}
      <Badge
        variant="outline"
